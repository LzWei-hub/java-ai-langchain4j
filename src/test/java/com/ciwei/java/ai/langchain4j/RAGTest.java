...
public class RAGTest {
    ...
    public void testReadDocument2() {
        // 加载单个文档
        Document document = FileSystemDocumentLoader.loadDocument("E:/knowledge/测试.txt", new
                TextDocumentParser());
        System.out.println(document.text());
    }
    @Test
    public void testReadDocument3() {
        ...
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("E:/knowledge", new
                TextDocumentParser());
        documents.forEach(document -> System.out.println(document.text()));
    }

    @Test
    public void testReadDocument4() {
        // 从一个目录中加载所有的.txt文档
